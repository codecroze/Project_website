...
<div class="container">
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#">5G INDIA</a>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <div class="card" style="width: 18rem;" id = "card-on-slider">
  <div class="card-body">
    ...
    <a href="#" class="btn btn-primary">Go somewhere</a>
      ...
      <img class="d-block w-100" src="img/board.jpg" alt="First slide">
  ...
  <div class="card-body">
    ...
    <a href="#" class="card-link">Another link</a>
      ...
      <img class="d-block w-100" src="img/city.jpg" alt="Second slide">
  ...
  <div class="card-body">
    ...
    <a href="#" class="card-link">Another link</a>
      ...
      <img class="d-block w-100" src="img/join.jpg" alt="Third slide">
  ...
  <div class="card-body">
    ...
    <a href="#" class="card-link">Another link</a>
      ...
      <img class="d-block w-100" src="img/mboard.jpg" alt="Fourth slide">
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" id="second_carousel">
  <ol class="carousel-indicators">
    <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active"></li>
    <li data-target="#carouselExampleIndicators" data-slide-to="1"></li>
